...
public class WelcomeBackActivity extends AppCompatActivity {
    ...
    private static final String DUMMY_USERNAME = "irfan";
    private static final String DUMMY_PASSWORD = "irfan12";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.sharedPrefs = getSharedPreferences("sharedPrefs", Context.MODE_PRIVATE);
